...
type FakeNPM struct {
	ViewStub        func(packageName string, registry string) ([]byte, error)
...
func (fake *FakeNPM) View(packageName string, registry string) ([]byte, error) {
	fake.viewMutex.Lock()
...
func (fake *FakeNPM) ViewReturns(result1 []byte, result2 error) {
	fake.ViewStub = nil
...
func (fake *FakeNPM) ViewReturnsOnCall(i int, result1 []byte, result2 error) {
	fake.ViewStub = nil
